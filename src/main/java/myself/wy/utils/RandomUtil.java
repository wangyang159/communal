...
public class RandomUtil {
		...
		/**
		 *@描述 返回min-max之间的随机整数（包含min和max值）
		 *@作者 wangyang
		 *@创建时间 2022/10/25
		 *@参数 min-开始值,max-最大值
		 *@返回值 范围内的整数
		...
		/**
		 *@描述 在最小值min与最大值max之间截取subs个不重复的随机数
		 *@作者 wangyang
		 *@创建时间 2022/10/25
		 *@参数 min-最小值,max-最大值,subs-个数
		 *@返回值 包含随机数的int数组
		 */
